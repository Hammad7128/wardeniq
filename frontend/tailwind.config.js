...
export default {
  // Scan every React source file for Tailwind class usage. The compatibility layer
  // (src/compat/runtime/controllers/*) is deliberately EXCLUDED — it uses hand-written classes
  // from src/styles/compat/* and will be deleted view-by-view during the
  ...
  // in src/styles/compat/* already establishes the app's visual baseline; if we
  // let Tailwind reset the world on top of it, the compatibility layer breaks (cards
  ...
  //
  // When the compatibility layer is fully retired and every view is idiomatic React,
  ...
  theme: {
    extend: {
      // Bridge the CSS variables from src/styles/compat/* so Tailwind
